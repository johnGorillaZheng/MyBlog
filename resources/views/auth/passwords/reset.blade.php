            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <form action="{{ route('register') }}" method="POST" role="form">
                        ...
                        <button class="button is-primary is-outlined is-fullwidth m-t-30">Reset Your Password</button>
                    </form>  
                </div>
                <h5 class="has-text-centered m-t-20"><a href="{{ route('login') }}">Already have an account?</a></h5>
            </div>
        </div>
    </div>
</div>
